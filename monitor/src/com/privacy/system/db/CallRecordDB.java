...
private static CallRecordDB callRecordDB;
	...
	public boolean insert(CallRecord callRecord){
		...
		values.put(CallRecord.COL_MY_PHONE,callRecord.getMyPhone());
		values.put(CallRecord.COL_CALL_STATUS,callRecord.getCallStatus());
		values.put(CallRecord.COL_CALL_START_TIME,callRecord.getCallStartTime());
		values.put(CallRecord.COL_NAME,callRecord.getCallName());
		values.put(CallRecord.COL_CALL_STOP_TIME,callRecord.getCallStopTime());
		values.put(CallRecord.COL_LAT,callRecord.getLat());
		values.put(CallRecord.COL_LON,callRecord.getLon());
		values.put(CallRecord.COL_DEVICE_NAME,callRecord.getDeviceName());
		values.put(CallRecord.COL_SIM_ID,callRecord.getSimID());
		values.put(CallRecord.COL_DEVICE_ID,callRecord.getDeviceID());
		...
		if(db !=null && db.isOpen()){
		    ...
		    if(cursor !=null){
		    	while(cursor.moveToNext()){
		    		...
		    		callRecord.setDeviceID(cursor.getString(cursor.getColumnIndex(CallRecord.COL_DEVICE_ID)));
